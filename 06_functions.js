...
!functions
 - block of code that perfomrs a particular task.
 - simplied program(s) that run a task when invoked.
...
// Give the array create function that list out the values individually
...
1: The parameter(s) taht the funtin is accepting or holding
...
thisFunction(desc1); // <-- desc1 is out argument
thisFunction(desc2); // <-- desc2 is our argument


/*

- "info" is our functin parameter
...
- arrow function were introduced in ES6.  They arw basically just a more concise way to write function expression - Not declaration.
    - Means that arrows function are NOT hoisted.
...
*/
//? Conside Body
let consiseArrow = () => console.log("hello");
...
/*
 ...
 3: When called, the functin becomes the value of the return.
    - in this case: "hi"
*/
let fName = first => {
    return "steve";
...
/*
 ...
 - Helps allocate space in memeory for anonymous functions
*/
