/*
    - Create a function called "fizzBuzz". - CREATED 
    - Within the function, create a loop that counts from 1 to 100. - CREATED
      - Create a variable within the loop called "response". - CREATED
